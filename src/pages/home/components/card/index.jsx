          ...
          <div className="flex items-center gap-5">
            {
              card.loading ? <CardSkeleton cards={2}/> : card.list.map(item => (
                <SwiperSlide className='w-1/2 h-96 rounded-xl bg-gradient-to-br from-lime-400 p-10 relative flex flex-col justify-between mr-3 max-[450px]:h-80' key={item.id}>
                  <div>
                    ...
                    <div className='absolute z-0 right-4 top-10 w-[250px] h-[300px] max-[450px]:w-[180px] max-[450px]:h-[230px]'>
