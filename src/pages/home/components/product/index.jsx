            ...
            <div className="container">
                <div className="product-wrapper">
                            ...
                            products.loading ? <RecommendedListSkeleton cards={2} /> : products.list.map(item => (
                                <div className='w-[300px] h-3/4 group relative max-[1040px]:w-[235px] max-[1006px]:w-[280px] max-[955px]:w-[260px] max-[840px]:w-[240px] max-[774px]:w-[220px] max-[716px]:w-[200px] max-[654px]:w-[300px] max-[642px]:w-[280px] max-[604px]:w-[260px] max-[574px]:flex max-[574px]:w-full' key={item.id}>
                                    ...
                                    <div className='p-4 max-[684px]:p-2 max-[574px]:p-1 max-[435px]:p-0'>
                                        ...
                                        <button className='hidden group-hover:block absolute bottom-1/4 max-[1219px]:bottom-[170px] max-[1200px]:w-10/12 max-[971px]:bottom-[25%] max-[971px]:left-5 max-[890px]:w-[90%] max-[890px]:left-4 max-[790px]:bottom-[30%] max-[790px]:p-0 max-[784px]:bottom-[23%] max-[784px]:text-sm max-[784px]:h-11 max-md:h-10 max-md:p-1 max-[654px]:w-[260px] max-[648px]:bottom-[100px] max-[642px]:w-[250px max-[604px]:w-[220px] max-[574px]:bottom-0 h-14 border-solid border-transparent bg-lime-500 w-64 rounded-xl p-3 mb-5 ease-in-out duration-300 hover:bg-transparent hover:border-solid hover:border-white font-bold text-lg max-[574px]:block max-[574px]:w-auto max-[574px]:bg-transparent max-[574px]:hover:border-transparent max-[574px]:right-10 max-[500px]:m-0 max-[500px]:mb-[10px] max-[450px]:mb-0 text-center' onClick={() => handleAdd(item)}>
                                            <span className='block max-[574px]:hidden'>В корзину</span>
                                            <span className='hidden max-[574px]:block'><CartIcon /></span>
                                        </button>
                                    </div>
                                </div>
                            ))
                    ...
                    {/* <div className="flex gap-5 max-[1060px]:gap-3 max-[655px]:gap-1 max-[578px]:gap-5 flex-wrap max-[500px]:gap-5 max-[574px]:flex-col">
                        {
                            products.loading ? <RecommendedListSkeleton cards={2} /> :
