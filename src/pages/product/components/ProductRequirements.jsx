                    ...
                    product.minrequirements.map(item => (
                        <div key={item?.id}>
                            <div className='flex items-center justify-between py-3 max-sm:py-1'>
                                ...
                                <p className='w-1/2 font-normal text-lg text-white max-md:w-[30%] max-sm:text-sm max-sm:w-auto max-[570px]:text-xs max-[510px]:text-[10px]'>{item.value}</p>
                            </div>
                        </div>
                    ))
                }
                    ...
                    product.maxrequirements.map(el => (
                        <div key={el.id}>
                            <div className='flex items-center justify-between py-3 max-sm:py-1'>
                                ...
                                <p className='w-1/2 font-normal text-lg text-white max-md:w-[30%] max-sm:text-sm max-sm:w-auto max-[570px]:text-xs max-[510px]:text-[10px]'>{el.value}</p>
                            </div>
                        </div>
                    ))
                }
